...
public class ElasticsearchQueryMethod extends QueryMethod {
	...
	/**
	 * @return the query String defined in the {@link Query} annotation.
	 * Must not be {@literal null} when {@link #hasAnnotatedQuery()} returns true.
	 */
	@Nullable
	 ...
	 * @since 5.5
	 */
	public boolean hasAnnotatedSearchQuery() {

...
/**
 * Utility class to create a {@link ReactiveElasticsearchClients}
 *
 * @author Peter-Josef Meisch
 * @since 4.3
 */
public final class ReactiveElasticsearchClients {
	/**
	 * Creates a new {@link ReactiveElasticsearchClient}
	 *
	 * @param clientConfiguration configuration options
	 * @return client
	 */

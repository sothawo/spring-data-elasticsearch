...
.NOTE
This is a work in progress, so the documents, APIs and affected classes are subject to continous evolution and change
...
* it should be possible to use external client implementations that adhere to a to-be-defined API. This would for example allow Opensearch to provide their own implementation.
...
For clarification check the <<Class diagram>> at the end of this document. It shows the current and the planned state.
